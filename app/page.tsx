  ...
  return (
    <main className="max-w-6xl mx-auto">
      <div className="relative w-full h-64 bg-gray-800 flex flex-col items-center justify-center mb-12 rounded-b-lg overflow-hidden">
        ...
        <h1 className="relative text-5xl font-bold text-white mb-2">Papeleria FORTRESS</h1>
        <p className="relative text-gray-300 text-lg">La mejor selección de papeles, al mejor precio de erias</p>
      </div>
